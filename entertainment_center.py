...
second_hand_lions = media.Movie("Second Hand Lions",
                     "A boy becomes a man",
...
evan_almighty = media.Movie("Evan Almighty", "A congressman builds an ark",
                          "https://upload.wikimedia.org/wikipedia/en/1/14/Evan_almightymp1.jpg",
                          "https://www.youtube.com/watch?v=vtJbcMJLhJss")

matrix = media.Movie("The Matrix", "A great sci fi movie",
